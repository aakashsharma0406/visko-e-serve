...
customers on a specific time;</p>
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src={details} alt="" class="img-fluid" style={{height:"250px"}}/>
                  </div>
                </div>
              </div>
...
the user to schedule important or marketing communications</p>
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img style={{height:"250px",width:"90%"}} src={details2} alt="" class="img-fluid"/>
                  </div>
                </div>
              </div>
...
applications come with unnecessary complex user interfaces which result in a lot of</p>
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src={details4} alt="" class="img-fluid" style={{height:"250px",width:"90%"}}/>
                  </div>
                </div>
              </div>
            </div>
